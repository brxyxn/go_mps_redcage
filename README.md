...
- [Heroku](https://mpsgo.herokuapp.com/docs)

> Important Note: this project won't accept Pull Requests, however, you can use it as a reference if need it to build your own project. You can see this API deployed to Heroku: https://mpsgo.herokuapp.com
...
2. [Getting Started](#getting-started)
   - [Docker](#docker) - [Pull repository](#pull-repository) - [Versions](#versions)
...
I used swagger.io and Redoc to document this API, the default URI to see the documentation is:
...
```plsql
-- Remove these lines if you need to keep records up, this is added by default if you are using a free tier production service.
...
|         GET | /api/v1/clients/**{client_id}**                                        | Get Single Client    |
|        POST | /api/v1/clients/**{client_id}**/accounts                               | New Account          |
|         GET | /api/v1/clients/**{client_id}**/accounts                               | Get All Accounts     |
|         GET | /api/v1/clients/**{client_id}**/accounts/**{account_id}**              | Get Single Account   |
|        POST | /api/v1/clients/**{client_id}**/accounts/**{account_id}**/transactions | New Transaction      |
|         GET | /api/v1/clients/**{client_id}**/accounts/**{account_id}**/transactions | Get All Transactions |

I have attached a postman file with all these tests pre-filled in /docs/go_mps_redcage.postman_collection.json.
...
> /api/v1/clients/_5_/accounts/_8_/transactions
